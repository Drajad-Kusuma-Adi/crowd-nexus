...
function EventCreator() {
    const { coords, isGeolocationAvailable, isGeolocationEnabled } = useGeolocated({
      ...
      function submitEvent(event: React.FormEvent<HTMLFormElement>) {
        ...
        if (tickets.length < 1) {
            alert('Please add at least 1 ticket');
            return;
        }
      ...
      return (
        coords && (
            <div className="container w-[80vw] font-ubuntu-condensed">
                ...
                <br />
                <form className='p-4 border-2 rounded-lg' onSubmit={addTicket}>
                    <div className="flex flex-col lg:flex-row justify-around items-center">
                        <div className="flex flex-col items-start">
                            <label htmlFor="ticketName">Ticket Name</label>
                            <br />
                            <input required className='w-full bg-white p-2 border-2 rounded-lg' type="text" name="ticketName" id="ticketName" placeholder="Enter ticket name..." />
                            <br /><br />
                            <label htmlFor="ticketBenefits">Ticket Benefits</label>
                            <br />
                            <textarea required className='w-full bg-white p-2 border-2 rounded-lg' name="ticketBenefits" id="ticketBenefits" placeholder="Explain what will people get in this ticket..."></textarea>
                            <br /><br />
                        ...
                        <div className="flex flex-col items-center border-2 rounded-lg p-2 w-[80vw] my-4 lg:w-[20vw] h-[50vh] overflow-y-scroll">
                            <p className="text-center font-bold text-2xl font-ubuntu my-4">Ticket List</p>
                            {tickets.length > 0 ? tickets.map((ticket, index) => (
                                <div className="my-2 w-[300px] flex flex-col items-center rounded-lg border-2 py-4 px-8">
                ...
                <br />
                <form className='p-4 border-2 rounded-lg text-center' onSubmit={submitEvent} encType="multipart/form-data">
                    <div className='text-start'>
                        <label className='ms-2' htmlFor="title">Event Title</label>
                    <br />
                    <input required className='w-full bg-white p-2 border-2 rounded-lg' type="text" name="title" id="title" placeholder="Enter event name..." /></div>
                    <br /><br />
                    <div className='text-start'>
                        <label className='ms-2' htmlFor="description">Event Description</label>
                    <br />
                    <textarea className='w-full bg-white p-2 border-2 rounded-lg' name="description" id="description" placeholder="Write an elaborate description on what will happen on your event..."></textarea></div>
                    <br /><br />
                    <div className="flex justify-between flex-wrap">
                        <div className="">
                            ...
                            <br />
                            <input required className='w-full bg-white p-2 border-2 rounded-lg' type="date" name="date" id="date" /></div>
                        </div>
                        <div className="">
                            <div>
                                <label htmlFor="startTime">Start Time</label>
                            <br />
                            <input required className='w-full bg-white p-2 border-2 rounded-lg' type="time" name="time" id="time" placeholder='hh:mm' /></div>
                        </div>
                    </div>
                    <br /><br />
                    <div className='text-start'>
                    ...
                    <br />
                    <input required className='w-full bg-white p-2 border-2 rounded-lg' type="file" name="image" id="image" accept="image/*" /></div>
                    <br /><br />
                    <div className='text-start'>
                        <label className='ms-2' htmlFor="location">Event Location</label>
                        <input required className='w-full bg-white p-2 border-2 rounded-lg' type="text" name="location" id="location" placeholder="Enter event location..." />
                        </div>
                    <br />
