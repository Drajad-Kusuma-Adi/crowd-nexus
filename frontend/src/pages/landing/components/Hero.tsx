            ...
            <section id="home">
                ...
                <div className="flex justify-center mt-4">
                    <div className="flex flex-col">
                        <a className="mx-4 my-2 ps-5 pe-5 py-2 text-center text-white bg-blue-600 hover:bg-blue-800 hover:text-white transition duration-300 font-medium rounded-lg font-ubuntu-condensed" href="./register">Sign me Up!</a>
                        <a className="mx-4 my-2 ps-5 pe-5 py-2 text-center text-white bg-blue-600 hover:bg-blue-800 hover:text-white transition duration-300 font-medium rounded-lg font-ubuntu-condensed" href="./map">Continue as Guest</a>
                    </div>
