        ...
        <>
            <section id="home">
                ...
                <div className="flex justify-center">
                    <a className="m-4 ps-5 pe-5 py-2 text-center text-white bg-blue-600 hover:bg-blue-700 hover:text-white transition duration-300 font-medium rounded-lg font-ubuntu-condensed" href="./register">Sign Me Up!</a>
